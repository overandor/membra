  ...
  return (
    <section className="p-[1.5%] bg-zinc-950">
      ...
      <div className="relative isolate w-full min-h-[calc(100svh-3vh)] sm:min-h-[calc(100svh-3vh)]">
        ...
        >
          ...
          <div className="absolute bottom-6 left-6 right-6 max-w-[min(46rem,92vw)] md:bottom-8 md:left-8 z-10">
            ...
            >
              ...
              <h1 className="text-balance text-3xl/tight sm:text-4xl/tight md:text-5xl/tight tracking-tight text-amber-50">
                Every apartment is the nearest warehouse
              </h1>
              <p className="mt-3 text-sm/6 text-amber-100/85 max-w-prose">
                Private inventory. Public utility. Turn your household reality into local economic opportunity.
              </p>
              <Link
                href="#demo"
                className="mt-4 inline-flex items-center rounded-full border border-amber-400/50 bg-amber-600/10 px-4 py-2 text-sm font-medium text-amber-50 backdrop-blur hover:bg-amber-600/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400"
              >
                GET STARTED
              </Link>
            </div>
        ...
        <div
          ref={customCursorRef}
          className={`fixed w-[30px] h-[30px] rounded-full bg-amber-600 pointer-events-none z-50 transition-opacity duration-200 ${
        ...
        <div className="absolute right-[0.85%] top-[0.75%] z-20">
          <Link
            href="/inventory"
            className="rounded-full bg-amber-600 px-4 py-2 text-sm font-mono font-light uppercase tracking-[-0.01em] text-white shadow-md hover:bg-amber-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-400"
          >
            SCAN
          </Link>
        </div>
